...
namespace UnityStandardAssets.Cameras
{
    public class FreeLookCam : PivotBasedCameraRig
    {
        ...
        protected void Update()
        {
            ...
            m_Target.rotation = Quaternion.Slerp(m_Target.rotation, Quaternion.Euler(m_Target.rotation.x, m_Cam.transform.eulerAngles.y, m_Target.rotation.z), Time.deltaTime * 50);
